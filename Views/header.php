...
<!-- bootstrap theme -->
<link href="..\back\NiceAdmin/css/bootstrap-theme.css" rel="stylesheet">
<!--external css-->
<!-- font icon -->
<link href="..\back\NiceAdmin/css/elegant-icons-style.css" rel="stylesheet" />
<link href="..\back\NiceAdmin/css/font-awesome.min.css" rel="stylesheet" />
<!-- Custom styles -->
<link href="..\back\NiceAdmin/css/style.css" rel="stylesheet">
<link href="..\back\NiceAdmin/css/style-responsive.css" rel="stylesheet" />
...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <a  class="logo"><img src="logo.png" height="40" width="40"></a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          <li class=""><a class="" href="home.php"> <i
              class="icon_house_alt"></i> <span>Home</span>
          </a></li>
          <li class=""><a class="" href="afficherCommande.php"> <i
              class="icon_document_alt"></i> <span>Commandes</span>
          </a></li>
        
          <li class=""><a class="" href="ajoutLivraison.php"> <i
              class="icon_genius"></i> <span>ajout livraison</span>
          </a></li>
          <li class=""><a class="" href="afficherLivraison.php"> <i
              class="icon_desktop"></i> <span>Livraisons</span>
          </a></li>
          <ul>
